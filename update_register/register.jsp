...
<html lang="zh-TW">
  ...
  <body>
                ...
                >
                  ...
                  >
                    <img
										...
										id="headPicture" class="rounded-circle" style="border: 3px solid rgb(196, 190, 190);">
                    <!-- <img
                      src="https://i.imgur.com/MCiLhIE.png"
                      id="headPicture"
                      class="m-x-auto img-fluid img-circle rounded-circle"
                  ...
                  <div id="boxFileSelect" class="d-flex justify-content-center">
                    ...
                    <p class="file">
                      <input
                        ...
                        id="fileSelect"
                      />
                      <label for="file" class="rounded">上傳你的個人照片</label>
                    </p>
                  </div>

                  <!-- 性別 -->
                  <div class="d-flex justify-content-center gender mb-3">
                    <input type="radio" class="magic-radio" id="male" name="gender" value="男" required="required"
                    ...
                    <!-- <input
                      ...
                      required="required"
                    /> -->
                    <label for="male" class="mr-2">男</label>
                    <input type="radio" class="magic-radio" id="female" name="gender" value="女" required="required"
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-1 mb-3">
                      <input
                        ...
                        id="btUserName"
                        value="重複檢查"
                        class="btn text-white" style="background-color: rgb(196,190,190);"
                      />
                    </div>
                    <!--帳號 error msg -->
                    <div class="errorText col-sm-10 text-danger mb-2 " id="userNameText">
                      ${errorMsg.errorId}
										</div>
                    <!-- ===密碼=== -->
                    ...
                    <!-- email err msg -->
                    <div class="errorText col-sm-10 text-danger mb-2" id="emailText">
                      ${errorMsg.errorEmail}
                    </div>
                    ...
                    <!-- 地址 -->
                    <div role="tw-city-selector" id="address" class="col-sm-10 my-style-selector" >
    ...
    <!--========= footer================= -->
    <footer
      class="page-footer font-small pt-5"
    ...
    >
      <div class="container text-center text-md-left">
        <div class="row">
          ...
          <div class="col-md-4 mx-auto">
            ...
            <p>
              是個能夠預期回應溫度的論壇空間。無論感情、生活、工作、時事都可以聊，還附設購物商城「要買啦！💸」，各種新奇有趣的商品都在這裡。
            </p>
          </div>
      ...
      <div class="footer-copyright text-center pb-4">
        © 2020 Copyright © 2020 Speak It Up. All rights reserved
      </div>
      <!-- Copyright -->
    </footer>
